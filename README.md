## pheeno_ros (kinetic) - 0.1.1-3

The packages in the `pheeno_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic pheeno_ros` on `Mon, 16 Apr 2018 22:41:37 -0000`
